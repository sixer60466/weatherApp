//匯入日出日落資料
import sunriseAndSunsetData from './A-B0062-001.json';

export const getMoment = (CountyName) => {
    //從日出日落時間中找出符合的地區
    ...
    //找不到的話則拋出錯誤訊息
    if (!locationDate) {
        throw new Error(`找不到 ${CountyName} 在 ${nowDate} 的日出日落資料`);
    }
